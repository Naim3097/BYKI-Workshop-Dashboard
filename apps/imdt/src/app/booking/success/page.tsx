...
export default function BookingSuccessPage() {
  ...
  const waText =
    status === 'confirmed'
      ? `Hi IM Dynamic Torque, saya dah bayar deposit RM${BIZ.feeRM} untuk tempah slot. Mohon sahkan temujanji saya.`
      : `Hi IM Dynamic Torque, saya cuba tempah slot tapi tak pasti pembayaran berjaya. Boleh tolong semak?`;
