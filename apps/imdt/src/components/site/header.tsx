  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-[var(--bg)]/85 backdrop-blur-xl">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center gap-3">
        <a href="#top" className="flex items-center gap-2.5 shrink-0" aria-label={BIZ.name}>
          <Image
            src="/logo-mark.jpg"
            alt={BIZ.name}
            width={44}
          ...
          />
          <span className="font-semibold tracking-tight text-white text-sm sm:text-[15px] leading-none">
            IM <span className="text-[var(--accent)]">Dynamic Torque</span>
          </span>
        </a>
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <CartButton />
          <a
            href={waLink('Hi IM Dynamic Torque, saya nak tanya pasal servis.')}
            target="_blank"
