// ─────────────────────────────────────────────────────────────────────
// Overhaul In Yard — single landing page (Malay)
    ...
    <main id="top">
      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        {BIZ.heroImage && (
          ...
          <img src={BIZ.heroImage} alt="Bengkel Overhaul In Yard" fetchPriority="high" className="absolute inset-0 w-full h-full object-cover" />
        )}
        ...
        <div className="relative z-10 w-full max-w-3xl mx-auto px-4 sm:px-6 py-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-8">
            ...
            <a href={waLink('Hi Overhaul In Yard, saya nak tanya pasal servis.')} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-3.5 rounded-xl text-base font-semibold glass glass-hover text-white/90">
              WhatsApp Kami
            </a>
          </div>
      ...
      <section id="kepakaran" className="reveal scroll-mt-16 max-w-5xl mx-auto px-4 sm:px-6 py-16">
        <SectionTitle kicker="Sejak 2019" title={<>Kepakaran <Em>Kami</Em></>} center />
        ...
        <div className="grid gap-5 md:grid-cols-2 mt-8 items-stretch">
          <div className="glass rounded-2xl p-6 space-y-4">
            ...
            <div>
              ...
              <a href={waLink('Hi Overhaul In Yard, saya nak tempah slot.')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold bg-[var(--accent)] text-white hover:bg-[var(--accent-2)] transition-colors">
      ...
      <div className="sm:hidden fixed bottom-0 inset-x-0 z-50 safe-bottom">
        <div className="m-3 rounded-2xl border border-white/10 bg-[var(--bg-raised)]/95 backdrop-blur-xl p-2 flex gap-2 shadow-2xl">
          ...
          <a href={waLink('Hi Overhaul In Yard, saya nak tanya pasal servis.')} target="_blank" rel="noopener noreferrer" className="px-5 py-3 rounded-xl text-sm font-semibold glass text-white/80">
            WhatsApp
          </a>
        </div>
      </div>
...
const TINTS = [
  'bg-gradient-to-br from-[#CA2127]/12 to-transparent border-[#CA2127]/20',
...
const TRUST = [
  { t: 'Pakar Sejak 2019', d: 'Dipercayai komuniti Kedah untuk kerja gearbox & transmisi sejak 2019.' },
  { t: 'Tumpuan Transmisi', d: 'Kepakaran khusus baik pulih gearbox auto & CVT — bukan bengkel serba boleh biasa.' },
