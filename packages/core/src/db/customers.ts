...
// merge the vehicle. Returns the customer id. No-ops (returns null) if phone is
// blank.
...
// Increment lifetime totals after a successful payment.
...
// Link a (previously anonymous) diagnose session to a customer + booking.
