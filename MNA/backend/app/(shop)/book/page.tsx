  ...
  return (
    <div className="container-page py-8">
      <div className="mx-auto max-w-2xl">
        <h1 className="text-xl font-semibold text-ink">Book a service or inspection</h1>
        <p className="mt-2 text-sm text-ink-soft">
          Reserve a workshop slot with a small deposit. The deposit is collected
          now and goes towards your final bill.
        </p>
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                placeholder="e.g. Volkswagen Golf Mk7 1.4 TSI"
              />
            </div>
            <div>
